...
use crate::ed25519::utilities::mta::range_proofs::AliceProof;
...
pub struct MessageB {
    pub c: BigInt, // paillier encryption
    pub b_proof: DLogProof<Ed25519, Sha256>,
    pub beta_tag_proof: DLogProof<Ed25519, Sha256>,
}
...
impl MessageB {
    pub fn b(
        ...
        m_a: MessageA,
        dlog_statements: &[DLogStatement],
    ) -> Result<(Self, Scalar<Ed25519>, BigInt, BigInt), Error> {
    ...
    pub fn b_with_predefined_randomness(
        ...
        beta_tag: &BigInt,
        dlog_statements: &[DLogStatement],
    ) -> Result<(Self, Scalar<Ed25519>), Error> {
        ...
        let beta_tag_fe = Scalar::<Ed25519>::from(beta_tag);
        ...
        let beta = Scalar::<Ed25519>::zero() - &beta_tag_fe;
    ...
    pub fn verify_proofs_get_alpha(
        ...
        dk: &DecryptionKey,
        a: &Scalar<Ed25519>,
    ) -> Result<(Scalar<Ed25519>, BigInt), Error> {
        let alice_share = Paillier::decrypt(dk, &RawCiphertext::from(self.c.clone()));
        let g = Point::generator();
        let alpha = Scalar::<Ed25519>::from(alice_share.0.as_ref());
        let g_alpha = g * &alpha;
    ...
    pub fn verify_b_against_public(
        public_gb: &Point<Ed25519>,
        mta_gb: &Point<Ed25519>,
    ) -> bool {
        public_gb == mta_gb
    }
}
