...
impl AliceProof {
    ...
    pub fn verify(
        ...
        if self.s1 > Scalar::<Ed25519>::group_order().pow(3) {
            return false;
        }
    ...
    pub fn generate(
        ...
        let e = if check {
            let (X, u) = {
                ...
                let alpha = Scalar::<Ed25519>::from(&round1.alpha);
...
impl BobProofExt {
    pub fn verify(
        ...
        let (x1, x2) = {
            let ec_gen = Point::generator();
            let s1 = Scalar::<Ed25519>::from(&self.proof.s1);
            let e = Scalar::<Ed25519>::from(&self.proof.e);
...
pub(crate) mod tests {
    ...
    fn alice_zkp() {
        ...
        let a = Scalar::<Ed25519>::random().to_bigint();
